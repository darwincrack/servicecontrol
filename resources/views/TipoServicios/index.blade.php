...
<script>
    $(function() {
        $('#users-table').DataTable({
            ...
            ajax: 'tipo-servicios/data',
            "order": [[ 0, "desc" ]],
            "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "Todos"]],
            columns: [
                {data: 'id_tipo_servicios', name: 'id_tipo_servicios'},
            ...
            buttons: [
                { extend: 'copy'},
                {extend: 'csv'},
                {extend: 'excel', title: 'Reporte de Tipo de Servicios'},
                {extend: 'pdf', title: 'Reporte de Tipo de Servicios'},
