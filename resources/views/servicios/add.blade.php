...
@section('title', 'Agregar Servicio o Equipo')
...
@section('content')
        ...
        <div class="ibox float-e-margins animated fadeInDown">
            ...
            <div class="ibox-content">
                ...
                <br>
                <br>
                <form class="form-horizontal" method="post" action="{{ URL::asset('servicios/add') }}">
                    {!! csrf_field() !!}
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="ciudades" id="ciudades" data-rec="">
                                @foreach($data_ciudades as $data_ciudad)
                                    <option value="{{$data_ciudad->id_ciudad}}" {{($data_ciudad->id_ciudad==old("ciudades"))?"selected":""}}>{{$data_ciudad->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="tipo_procedencia" id="tipo_procedencia" data-rec="">
                                @foreach($data_tipo_procedencias as $data_tipo_procedencia)
                                    <option value="{{$data_tipo_procedencia->id_tipo_procedencia}}" {{($data_tipo_procedencia->id_tipo_procedencia==old("tipo_procedencia"))?"selected":""}}>{{$data_tipo_procedencia->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="procedencia" id="procedencia">
                                @foreach($data_procedencias as $data_procedencia)
                                    <option value="{{$data_procedencia->id_procedencia}}" {{($data_procedencia->id_procedencia==old("procedencia"))?"selected":""}}>{{$data_procedencia->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="tipo_servicio" id="tipo_servicio">
                                @foreach($data_tipo_servicios as $data_tipo_servicio)
                                    <option value="{{$data_tipo_servicio->id_tipo_servicios}}" {{($data_tipo_servicio->id_tipo_servicios==old("tipo_servicio"))?"selected":""}}>{{$data_tipo_servicio->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="operadora">
                                @foreach($data_operadoras as $data_operadora)
                                    <option value="{{$data_operadora->id_operadora}}" {{($data_operadora->id_operadora==old("operadora"))?"selected":""}}>{{$data_operadora->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="estatus">
                                @foreach($data_estatus as $data_estatu)
                                    <option value="{{$data_estatu->id_estatus}}" {{($data_estatu->id_estatus==old("estatus"))?"selected":""}}>{{$data_estatu->nombre}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-10">
                            <div class="switch">
                                <div class="onoffswitch">
                                    <input type="checkbox"   class="onoffswitch-checkbox" id="propio" name="propio" value="1"  checked >
                    ...
                    <div class="form-group{{ $errors->has('num_telefono_circuito') ? ' has-error' : '' }}"><label class="col-lg-2 control-label"><span style="color:#afafaf;">*</span> Num Telefono o Circuito</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="num_telefono_circuito" placeholder="Ejemplo: 02392253939" class="form-control" value="{{ old('num_telefono_circuito') }}">
                    ...
                    <div class="form-group{{ $errors->has('nombre_plan') ? ' has-error' : '' }}"><label class="col-lg-2 control-label"><span style="color:#afafaf;">*</span> Nombre del plan o equipo</label>

                        <div class="col-lg-10"><input type="text" name="nombre_plan" placeholder="Ejemplo: ABA para Todos" class="form-control" value="{{ old('nombre_plan') }}"> @if ($errors->has('nombre_plan'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('costo_plan') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Costo del plan</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="costo_plan" placeholder="Ejemplo: 2500" class="form-control" value="{{ old('costo_plan') }}"> @if ($errors->has('costo_plan'))
                                <span class="help-block">
                    ...
                    <div id="content_aba_movill" style="display: block">
                    <div class="form-group{{ $errors->has('imei') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">IMEI</label>

                        <div class="col-lg-10"><input type="text" name="imei" placeholder="Ejemplo: 350604106383727" class="form-control" value="{{ old('imei') }}">
                            @if ($errors->has('imei'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('modelo') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Modelo</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="modelo" id="modelo" placeholder="Ejemplo: 8310" class="form-control" value="{{ old('modelo') }}"> @if ($errors->has('modelo'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('serial') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Serial</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="serial" id="serial" placeholder="Ejemplo: 584670-001" class="form-control" value="{{ old('serial') }}"> @if ($errors->has('serial'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('fcc') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">FCC</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="fcc" id="fcc" placeholder="Ejemplo: 11235813" class="form-control" value="{{ old('fcc') }}"> @if ($errors->has('fcc'))
                                <span class="help-block">
                    ...
                    <div class="form-group{{ $errors->has('compania') ? ' has-error' : '' }}"><label class="col-sm-2 control-label"><span style="color:#afafaf;">*</span> Compa&ntilde;ia</label>

                        <div class="col-sm-10">
                            <select class="form-control" class="form-control m-b" name="id_compania">
                                @foreach($data_compania as $data_companias)
                                    <option value="{{$data_companias->id_compania}}" {{($data_companias->id_compania==old("operadora"))?"selected":""}}>{{$data_companias->nombre}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group{{ $errors->has('num_contrato') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Num Contrato</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="num_contrato" placeholder="Ejemplo: 11235813" class="form-control" value="{{ old('num_contrato') }}"> @if ($errors->has('num_contrato'))
                                <span class="help-block">
                        ...
                        <div class="col-lg-10">
                            <div  id="data_1">
                                ...
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="inicio_contrato" id="inicio_contrato" class="form-control" value="{{ old('inicio_contrato') }}">
                    ...
                    <div class="form-group{{ $errors->has('final_contrato') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Fecha Final Contrato</label>
                        ...
                        <div class="col-lg-10">
                            <div  id="data_1">
                                ...
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="final_contrato" id="final_contrato" class="form-control" value="{{ old('final_contrato') }}">
